...
@section('content')
    <header>
        <div class="container py-4">
            ...
            <a href="{{route('comic.create')}}" class="text-decoration-none bg-primary text text-white p-2 fw-bold">CREA FUMETTO</a>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                @foreach ($comics as $comic)
                    <a href="{{route('comic.show', $comic->id)}}" class="col-3 card d-flex flex-column gap-2 p-3 text-decoration-none">
